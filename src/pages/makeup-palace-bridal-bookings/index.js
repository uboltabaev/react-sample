...
function FormalBooking() {
    ...
    const isStep1Valid = useCallback(() => {
        const { noHairAndMakeup, noMakeupOnly, noBridesmaids, noExtraBridalPartyMembers } = state
        let foundErrorNum = 0
        ...
        if (noBridesmaids === '' || noBridesmaids == 0) {
            foundErrorNum ++
        }
        if (noExtraBridalPartyMembers === '' || noExtraBridalPartyMembers == 0) {
            foundErrorNum ++
        }
    ...
    const handleSubmit = async (event) => {
        ...
        if (isStep3Valid()) {
            ...
            const { noHairAndMakeup, noMakeupOnly, noBridesmaids, noExtraBridalPartyMembers, groupBookingDate, groupReadyTime, location, firstName, lastName, email, phoneNumber, additionalDetails } = state
            const data = {
                noHairAndMakeup,
                noMakeupOnly,
                noBridesmaids,
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <section className="booking-container">
                ...
                <h1>Makeup Palace Bridal Enquiries</h1>
                <p>
                    For all bridal bookings and enquiries, please fill 
                    out the form below and we’ll get back to you within 
                    a few hours!
                </p>
                <div className="booking-form">
                    <form name="booking-form" id="booking-form" method="post" action="/api/formal-booking" onSubmit={handleSubmit}>
                        ...
                        <input ref={formName} type={'hidden'} name="form-name" id="" value="bridal"/>
                            ...
                            <>
                                ...
                                <div className="input">
                                    <TextField id="outlined-basic" 
                                        ...
                                        type="number"
                                        fullWidth
                                        value={state.noBridesmaids}
                                        onChange={(event) => setState({...state, noBridesmaids: event.target.value})}
                                    />
                                </div>

                                <div className="input">
                                    <TextField id="outlined-basic" 
                                        label="No of extra bridal party members" 
                                        variant="outlined"
                                        sx={{
                                            input: {
                                                color: '#fff'
                                        ...
                                        type="number"
                                        fullWidth
                                        value={state.noExtraBridalPartyMembers}
                                        onChange={(event) => setState({...state, noExtraBridalPartyMembers: event.target.value})}
                                    />
                                </div>
